...
#ifdef	J2KILLBYCALL
	/*
 	 * 04Aug2021, Maiko (VE4KLM), this is to cut down FILE I/O and simplify
	 * the code in dodelmsg(), and now that I think of it, we might be able
	 * to use this information to cut down FILE I/O elsewhere in bmutil.c ?
	 */
	char *from;
	char *to;
#endif
