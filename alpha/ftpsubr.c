...
#ifdef HTTPVNC
        /*
	 * 25Aug2021, Maiko (VE4KLM), Don't want -more- prompts on browser sessions,
	 * interesting, sometimes 'm' is NULL and crash, so better check for it !
	 */
    	if (m && (m->type != WEB_LINK))
#endif
